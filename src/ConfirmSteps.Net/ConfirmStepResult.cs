  ...
  where T : class
{
  ...
  public ConfirmStepResult(string title,
    ConfirmStatus status, IEnumerable<StepResult<T>> stepResults,
  ...
  /// </summary>
  public IReadOnlyList<StepResult<T>> StepResults
  {
    get => stepResults.AsReadOnly();
  }
  ...
  public StepResult<T> this[int index]
  {
    get => stepResults[index];
  }
}
